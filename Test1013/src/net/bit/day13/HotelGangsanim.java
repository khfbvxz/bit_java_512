...
public class HotelGangsanim {
	...
	public void process() {// non-static메소드
		...
		int sel = 0;
		while (true) {
			System.out.print("\n1.투숙 2.퇴실 3.list 4.showStatus 9.종료 >>> ");
	...
	public void checkIn() { // non-static메소드
		...
		System.out.print(" >몇층에 투숙? "); // 3 층 실제배열은 2행
		floor = Integer.parseInt(sc.nextLine());
		System.out.print(" >몇호에 투숙? "); // 4 호 실제배열은 3열
	...
	public void showStatus() { // non-static메소드
		System.out.println("\n\t\t[ " + title + " 투숙 상태 ]");
		// 중첩for if문
	...
	public static void main(String[] args) {
		HotelGangsanim mm = new HotelGangsanim("델루나");
		mm.process();
	} // main end
}
